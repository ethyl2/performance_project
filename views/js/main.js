...
// Below is the old code, which appended the pizzas one-by-one.
//for (var i = 2; i < 100; i++) {
//  pizzasDiv.appendChild(pizzaElementGenerator(i));
//}

// Instead, here is a document fragment that is only appended to the pizzasDiv
...
// Added requestAnimationFrame since a visible change to the screen is made.
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // 25 pizzas are on a screen at a time. So we can decrease the number to
  // numPizzas.
